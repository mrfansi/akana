    ...
    put(route('teams.update', team.id), {
      onSuccess: () => {
        ...
        if (isInDialog && window.parent) {
          window.parent.location.href = route('teams.show', team.id);
        }
      }
    });
  };
      ...
      <div className="py-12">
        <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-2xl font-semibold text-gray-900 dark:text-gray-100">Team Details</h1>
                ...
                <form onSubmit={handleSubmit} className="px-4">
                  <div className="space-y-6">
                    ...
                    <div className="flex justify-end space-x-2 mt-6">
                      ...
                      <Button type="submit" disabled={processing}>Update Team</Button>
                    </div>
                  </div>
                </form>
              </DialogContent>
